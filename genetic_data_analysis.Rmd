...
highlight.sector(c(paste0("R", 1:6)), track.index = 2, col = "#FDCDAC", 
    text = "Reactome", cex = 0.7, text.col = "white", niceFacing = TRUE)
highlight.sector(c(paste0("W", 1:6)), track.index = 2, col = "#CBD5E8", 
    text = "WikiPathways", cex = 0.7, text.col = "white", niceFacing = TRUE)
highlight.sector(c(paste0("G", 1:6)), track.index = 2, col = "#B3E2CD", 
    text = "Gene Ontology", cex = 0.7, text.col = "white", niceFacing = TRUE)

#Add legend with EC code classification
col = c("1: Oxidoreductase" = "#ffa600",
        "2: Transferases" = "#ff6361",
        "3: Hydrolases" = "#bc5090",
        "4: Lyases" = "#58508d",
        "5: Isomerases" = "#003f5c",
        "6: Ligase" = "#000000") # EC 7: Translocases --> Not found.
...
png(filename="overlap_Genes_chordDiagram.png", width = 430, height = 280, units = "px") 
...
col = c("1: Oxidoreductase" = "#ffa600",
        ...
        "4: Lyases" = "#58508d",
        "5: Isomerases" = "#003f5c",
        "6: Ligases" = "#000000") # EC 7: Translocases --> Not found.
